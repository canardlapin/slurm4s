package io.github.bbuchsbaum.scalaslurm.examples
...
import io.github.bbuchsbaum.scalaslurm.ssh.*
...
class PublicApiExamplesSuite extends munit.CatsEffectSuite:
  ...
  test("local log pages resume from the returned cursor") {
    val root = Files.createTempDirectory("scala-slurm-examples-log")
  ...
  ): io.github.bbuchsbaum.scalaslurm.agent.AgentApi[IO] =
    new io.github.bbuchsbaum.scalaslurm.agent.AgentApi[IO]:
