...
import io.github.bbuchsbaum.scalaslurm.core.EnvironmentExportPolicy
import io.github.bbuchsbaum.scalaslurm.core.MemoryRequest
import io.github.bbuchsbaum.scalaslurm.core.NativeOption
...
object SlurmCommands:
  ...
  private def siteOptions(
      spec: io.github.bbuchsbaum.scalaslurm.core.EffectiveSiteSpec,
  ...
  private def exportOption(
    ...
    case EnvironmentExportPolicy.Explicit =>
      ...
      else s"--export=${environmentNames.toVector.sorted.mkString(",")}"

  private def arrayOption(request: io.github.bbuchsbaum.scalaslurm.core.JobArrayRequest): String =
